...
// func (d DockerApplicationManager) CreateNewService(ctx context.Context, name, image string, envs, labels []model.KeyValue) (*model.Service, error) {
