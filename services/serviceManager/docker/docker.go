...
func (d DockerApplicationManager) convertModelEnvToDockerEnv(envs []model.Env) []string {
...
func (d DockerApplicationManager) CreateNewContainer(ctx context.Context, image string, envs []model.Env) (string, string, error) {
	containerConfig := &container.Config{
		Image: image,
		Env:   d.convertModelEnvToDockerEnv(envs),
	}

	//TODO: should use one failure policy
