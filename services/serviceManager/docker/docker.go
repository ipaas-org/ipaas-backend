...
func (d DockerApplicationManager) CreateNewContainer(ctx context.Context, name, image string, envs, labels []model.KeyValue) (*model.Container, error) {
...
func (d DockerApplicationManager) StartContainerByID(ctx context.Context, id string) error {
...
func (d DockerApplicationManager) ConnectContainerToNetwork(ctx context.Context, id string, networkID, dnsAlias string) error {
